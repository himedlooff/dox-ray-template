var Doxray = {
  "patterns": [
    ...
    {
      "label": ".doxray-toc_file-list__bordered",
      "less": ".doxray-toc_file-list__bordered {\n    padding: @doxray-margin-sm;\n    border: 1px solid @doxray-color-dirtier-white;\n    border-radius: 5px;\n}",
      "filename": "doxray-template.less",
      "slug": "doxray-toc_file-list__bordered"
    },
    {
      "label": ".doxray-toc_file-list-item",
      "less": ".doxray-toc_file-list-item {\n    margin: 0;\n    padding: 0;\n}",
      "filename": "doxray-template.less",
      "slug": "doxray-toc_file-list-item"
    },
    {
      "label": ".doxray-link",
    ...
    },
    {
      ...
      "colorPalette": [
        ...
        {
          "variable": "@doxray-color-light-gray",
          "value": "#969696"
        },
        {
